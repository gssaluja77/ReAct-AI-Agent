...
You are only allowed to read, write, list, or execute files inside the sandbox folder located in the root directory of this project (at './sandbox'). Any request to access files outside this folder should be rejected.
